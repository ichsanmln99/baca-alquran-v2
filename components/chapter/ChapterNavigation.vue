<template>
  <div class="flex justify-between p-2 items-center relative mb-5">
    <div>
      <NuxtLink
        :to="{
...
const { getChapterNavigation } = useChapters();

const chapterNavigation = getChapterNavigation(props.id);
</script>
